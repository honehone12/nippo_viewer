...
<div class="navbar bg-base-300 print-exclude">
    <div class="navbar-start">
        <div class="join grid grid-cols-2">
            <button
                aria-label="back" 
                class="join-item btn btn-sm btn-circle btn-outline btn-primary"
